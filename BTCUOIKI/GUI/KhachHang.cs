...
namespace BTCUOIKI.GUI
{
    public partial class KhachHang : Form
    {
        ...
        private void dgvKhachHang_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtMaKhachHang.Text = dgvKhachHang.Rows[d].Cells[0].Value.ToString(); // Gán giá trị Mã khách hàng
            txtTenKhachHang.Text = dgvKhachHang.Rows[d].Cells[1].Value.ToString(); // Gán giá trị Tên khách hàng
            txtSoDienThoai.Text = dgvKhachHang.Rows[d].Cells[2].Value.ToString(); // Gán giá trị Số điện thoại
